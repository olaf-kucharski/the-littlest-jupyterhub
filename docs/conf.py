...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/olaf-kucharski/the-littlest-jupyterhub",
...
linkcheck_ignore = [
    ...
    "https://github.com/olaf-kucharski/the-littlest-jupyterhub/pull/",  # too many PRs in changelog
    "https://github.com/olaf-kucharski/the-littlest-jupyterhub/compare/",  # too many comparisons in changelog
]
